"""
This contains code to implement GradCam using PyTorch
Thankfully borrowed from https://github.com/vickyliin/gradcam_plus_plus-pytorch/blob/master/gradcam/gradcam.py
"""
import torch
